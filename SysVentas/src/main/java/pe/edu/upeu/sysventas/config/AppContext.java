...
public class AppContext {
    ...
    private void registrarServicios() {
        registrar(
                ICategoriaService.class,
                new CategoriaServiceImp(
        ...
        registrar(
                IMarcaService.class,
                new MarcaServiceImp(
                        getBean(MarcaRepository.class)
                )
        );

        registrar(
                IProductoService.class,
                new ProductoServiceImp(
                        getBean(ProductoRepository.class)
                )
        );

        registrar(
                IUnidadMedidaService.class,
                new UnidadMedidaServiceImp(
    ...
    private void registrarControladores() {
        ...
        registrar(
                CompCarritoController.class,
                new CompCarritoController()
        );
    }
